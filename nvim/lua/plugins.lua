...
require("lazy").setup({
	...
	},
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>ff", builtin.find_files, { desc = "find files inside current working file." })
			vim.keymap.set("n", "<leader>fg", builtin.live_grep, { desc = "live grep inside project." })
	...
	{ "folke/neodev.nvim", opts = {} },
	{
		...
		config = function(_, opts)
			...
			dap.adapters.java = {
				...
				command = "java",
				args = {
					"-agentlib:jdwp=transport=dt_socket,address=5005,server=y,suspend=n, -jar",
					vim.fn.expand(
						"~/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-0.53.1.jar"
					),
				},
			}
